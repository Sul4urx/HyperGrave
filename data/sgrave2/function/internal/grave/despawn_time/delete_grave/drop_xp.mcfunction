...
execute if score (dropped_contents/no_gravity_xp) sgrave2.config matches 1 run data modify entity @n[tag=sgrave2.temp.grave.xp_to_drop] NoGravity set value 1b
