...
data modify storage sgrave2:common temp.value set from storage sgrave2:common temp.config_copy.item_distribution.keep[-1]
...
} run scoreboard players set .keep_item sgrave2.temp_var 1

## Iterate to next predicate
data modify storage sgrave2:common temp.config_copy.item_distribution.keep append from storage sgrave2:common temp.config_copy.item_distribution.keep[0]
data remove storage sgrave2:common temp.config_copy.item_distribution.keep[0]
...
function sgrave2:internal/grave/generate/distribute_items/keep/check_item_predicates with storage sgrave2:common temp.args
