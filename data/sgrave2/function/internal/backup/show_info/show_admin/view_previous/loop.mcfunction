#<< backup/show_info/show_admin/view_previous/loop
#<< backup/show_info/show_admin/view_previous
...
return run function sgrave2:internal/backup/show_info/show_admin/view_previous/loop with storage sgrave2:common temp.args1
