...
execute store result score .return_value sgrave2.temp_var run function sgrave2:internal/backup/show_info/show_admin/view_previous/loop with storage sgrave2:common temp.args1
