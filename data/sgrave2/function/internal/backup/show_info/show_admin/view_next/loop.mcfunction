#<< backup/show_info/show_admin/view_next/loop
#<< backup/show_info/show_admin/view_next
...
return run function sgrave2:internal/backup/show_info/show_admin/view_next/loop with storage sgrave2:common temp.args1
