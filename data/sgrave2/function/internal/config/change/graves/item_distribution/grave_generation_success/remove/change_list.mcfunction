...
execute unless data storage sgrave2:common temp.config.value[] unless data storage sgrave2:common temp.config{value:[]} run title @s actionbar {\
  "translate": "sgrave2.change_config_message.item_distribution.grave_generation_success.remove.change_list.fail.not_a_list",\
...
function sgrave2:internal/config/change/graves/item_distribution/grave_generation_success/remove/change_list/check_value with storage sgrave2:common temp.args
...
execute if data storage sgrave2:common temp.config.value[] unless score .list_is_valid sgrave2.temp_var matches 1 run title @s actionbar {\
  "translate": "sgrave2.change_config_message.item_distribution.grave_generation_success.remove.change_list.fail.not_valid",\
...
execute if data storage sgrave2:common temp.config.value[] if score .list_is_valid sgrave2.temp_var matches 1 run title @s actionbar {\
  "translate": "sgrave2.change_config_message.item_distribution.grave_generation_success.remove.change_list.success",\
...
execute if data storage sgrave2:common temp.config.value[] if score .list_is_valid sgrave2.temp_var matches 1 run data modify storage sgrave2:common configs.value.graves.item_distribution.grave_generation_success.remove set from storage sgrave2:common temp.config.value
execute if data storage sgrave2:common temp.config{value:[]} run data modify storage sgrave2:common configs.value.graves.item_distribution.grave_generation_success.remove set value []
