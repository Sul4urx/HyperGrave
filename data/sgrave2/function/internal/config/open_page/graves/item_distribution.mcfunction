...
tellraw @s [\
  "",\
  {\
    "translate": "sgrave2.config_category.item_distribution.",\
...
tellraw @s [\
  {\
    "translate": "sgrave2.config.item_distribution.grave_generation_fail",\
...
tellraw @s [\
  {\
    "translate": "sgrave2.config.item_distribution.grave_generation_fail.operation",\
    "fallback": "     Operation: ",\
    "hover_event": {\
      "action":"show_text",\
      "value": {\
  ...
  {\
    ...
    "click_event": {\
      "action": "run_command",\
      "command": "/function sgrave2:internal/config/toggle/graves/item_distribution/grave_generation_fail/operation"\
    }\
  }\
]
...
tellraw @s [\
  {\
    "translate": "sgrave2.config.item_distribution.grave_generation_success",\
...
tellraw @s [\
  {\
    "translate": "sgrave2.config.item_distribution.grave_generation_success.remove",\
    "fallback": "     Remove: ",\
    "hover_event": {\
      "action":"show_text",\
      "value": {\
  ...
  {\
    ...
    "hover_event": {\
      "action": "show_text",\
      "value": {\
        "translate": "sgrave2.config_change_description.item_distribution",\
    ...
    "click_event": {\
      ...
      "command": "/function sgrave2:internal/config/change/graves/item_distribution/grave_generation_success/remove/change_list {value:[{…}]}"\
    }\
  }\
]
...
tellraw @s [\
  {\
    "translate": "sgrave2.config.item_distribution.grave_generation_success.keep",\
    "fallback": "     Keep: ",\
    "hover_event": {\
      "action":"show_text",\
      "value": {\
  ...
  {\
    ...
    "click_event": {\
      "action": "suggest_command",\
      "command": "/function sgrave2:internal/config/change/graves/item_distribution/grave_generation_success/keep/change_list {value:[{…}]}"\
    }\
  }\
]
  ...
  {\
    ...
    "with": [\
      ...
      {\
        ...
        "click_event": {\
          "action": "run_command",\
          "command": "/function sgrave2:internal/config/open_page/graves/item_distribution"\
        }\
      }\
    ]\
  }\
