...
tellraw @s [\
  ...
  {\
    ...
    "clickEvent": {\
      "action": "run_command",\
      "value": "/function sgrave2:internal/config/toggle/graves/item_distribution/grave_generation_fail/operation"\
    }\
  }\
]
...
tellraw @s [\
  ...
  {\
    ...
    "clickEvent": {\
      ...
      "value": "/function sgrave2:internal/config/change/graves/item_distribution/grave_generation_success/remove/change_list {value:[{…}]}"\
    }\
  }\
]
...
tellraw @s [\
  ...
  {\
    ...
    "clickEvent": {\
      "action": "suggest_command",\
      "value": "/function sgrave2:internal/config/change/graves/item_distribution/grave_generation_success/keep/change_list {value:[{…}]}"\
    }\
  }\
]
