...
tellraw @s [\
  ...
  {\
    ...
    "clickEvent": {\
      ...
      "value": "/function sgrave2:internal/config/change/graves/slot_distribution/grave_generation_success {value: {…}}"\
    }\
  }\
]
  ...
  {\
    ...
    "with": [\
      ...
      {\
        ...
        "clickEvent": {\
          "action": "run_command",\
          "value": "/function sgrave2:internal/config/open_page/graves/slot_distribution"\
        }\
      }\
    ]\
  }\
