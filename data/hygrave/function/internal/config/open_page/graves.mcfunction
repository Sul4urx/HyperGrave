...
tellraw @s [\
  ...
  {\
    ...
    "clickEvent": {\
      "action": "run_command",\
      "value": "/function hygrave:internal/config/toggle/graves/drop_contents_on_despawn"\
    }\
  }\
]
...
tellraw @s [\
  ...
  {\
    ...
    "clickEvent": {\
      "action": "run_command",\
      "value": "/function hygrave:internal/config/toggle/graves/glowing_graves"\
    }\
  }\
]
...
tellraw @s [\
  ...
  {\
    ...
    "clickEvent": {\
      ...
      "value": "/function hygrave:internal/config/change/graves/grave_despawn_time {value: ?}"\
    }\
  }\
]
...
tellraw @s [\
  ...
  {\
    ...
    "clickEvent": {\
      "action": "run_command",\
      "value": "/function hygrave:internal/config/open_page/graves/icd_properties"\
    }\
  }\
]
...
tellraw @s [\
  ...
  {\
    ...
    "clickEvent": {\
      "action": "run_command",\
      "value": "/function hygrave:internal/config/open_page/graves/slot_distribution"\
    }\
  }\
]
...
tellraw @s [\
  ...
  {\
    ...
    "clickEvent": {\
      "action": "run_command",\
      "value": "/function hygrave:internal/config/toggle/graves/tell_grave_mini_info"\
    }\
  }\
]
...
tellraw @s [\
  ...
  {\
    ...
    "clickEvent": {\
      "action": "run_command",\
      "value": "/function hygrave:internal/config/open_page/graves/xp_distribution"\
    }\
  }\
]
  ...
  {\
    ...
    "with": [\
      {\
        ...
        "clickEvent": {\
          "action": "run_command",\
          "value": "/function hygrave:internal/config/open_page/main"\
        }\
      },\
      {\
        "text": " §b🔃 Refresh",\
