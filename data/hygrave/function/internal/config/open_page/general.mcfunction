...
tellraw @s [\
  ...
  {\
    ...
    "clickEvent": {\
      "action": "run_command",\
      "value": "/function hygrave:internal/config/toggle/general/change_gamerules"\
    }\
  }\
]
...
tellraw @s [\
  ...
  {\
    ...
    "clickEvent": {\
      "action": "run_command",\
      "value": "/function hygrave:internal/config/toggle/general/mod_compability_mode"\
    }\
  }\
]
...
tellraw @s [\
  ...
  {\
    ...
    "clickEvent": {\
      ...
      "value": "/function hygrave:internal/config/change/general/mod_compatibility_mode/item_collection_distance {value: ?}"\
    }\
  }\
]
