...
tellraw @s [\
  {\
    "translate": "hygrave.config.slot_distribution.grave_generation_fail",\
...
tellraw @s [\
  {\
    "translate": "hygrave.config.slot_distribution.grave_generation_success",\
  ...
  {\
    ...
    "hoverEvent": {\
      "action": "show_text",\
      "contents": {\
        "translate": "hygrave.config_change_description.slot_distribution",\
    ...
    "clickEvent": {\
      ...
      "value": "/function hygrave:internal/config/change/graves/slot_distribution/grave_generation_success {value: {…}}"\
    }\
  }\
]
