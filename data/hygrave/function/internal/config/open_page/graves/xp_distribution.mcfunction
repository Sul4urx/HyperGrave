...
tellraw @s [\
  ...
  {\
    ...
    "clickEvent": {\
      ...
      "value": "/function hygrave:internal/config/change/graves/xp_distribution/grave_generation_fail/remove {value: ?}"\
    }\
  }\
]
...
tellraw @s [\
  ...
  {\
    ...
    "clickEvent": {\
      "action": "suggest_command",\
      "value": "/function hygrave:internal/config/change/graves/xp_distribution/grave_generation_fail/keep {value: ?}"\
    }\
  }\
]
...
tellraw @s [\
  ...
  {\
    ...
    "clickEvent": {\
      "action": "suggest_command",\
      "value": "/function hygrave:internal/config/change/graves/xp_distribution/grave_generation_success/remove {value: ?}"\
    }\
  }\
]
...
tellraw @s [\
  ...
  {\
    ...
    "clickEvent": {\
      "action": "suggest_command",\
      "value": "/function hygrave:internal/config/change/graves/xp_distribution/grave_generation_success/keep {value: ?}"\
    }\
  }\
]
...
tellraw @s [\
  ...
  {\
    ...
    "clickEvent": {\
      "action": "suggest_command",\
      "value": "/function hygrave:internal/config/change/graves/xp_distribution/grave_generation_success/take {value: ?}"\
    }\
  }\
]
