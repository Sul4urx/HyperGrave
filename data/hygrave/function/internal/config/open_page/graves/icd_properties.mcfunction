...
tellraw @s [\
  ...
  {\
    ...
    "clickEvent": {\
      "action": "run_command",\
      "value": "/function hygrave:internal/config/toggle/graves/icd/activate_for"\
    }\
  }\
]
...
tellraw @s [\
  ...
  {\
    ...
    "clickEvent": {\
      ...
      "value": "/function hygrave:internal/config/change/graves/icd/item_cycle_cooldown {value: ?}"\
    }\
  }\
]
...
tellraw @s [\
  ...
  {\
    ...
    "clickEvent": {\
      "action": "run_command",\
      "value": "/function hygrave:internal/config/toggle/graves/icd/revert_sneaking_behavior"\
    }\
  }\
]
...
tellraw @s [\
  ...
  {\
    ...
    "clickEvent": {\
      "action": "run_command",\
      "value": "/function hygrave:internal/config/toggle/graves/icd/switch_text_display"\
    }\
  }\
]
