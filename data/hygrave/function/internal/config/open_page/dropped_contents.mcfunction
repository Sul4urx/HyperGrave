...
tellraw @s [\
  ...
  {\
    ...
    "clickEvent": {\
      "action": "run_command",\
      "value": "/function hygrave:internal/config/toggle/dropped_contents/invulnerable_items"\
    }\
  }\
]
...
tellraw @s [\
  ...
  {\
    ...
    "clickEvent": {\
      "action": "run_command",\
      "value": "/function hygrave:internal/config/toggle/dropped_contents/invulnerable_xp"\
    }\
  }\
]
...
tellraw @s [\
  ...
  {\
    ...
    "clickEvent": {\
      "action": "run_command",\
      "value": "/function hygrave:internal/config/toggle/dropped_contents/no_gravity_items"\
    }\
  }\
]
...
tellraw @s [\
  ...
  {\
    ...
    "clickEvent": {\
      "action": "run_command",\
      "value": "/function hygrave:internal/config/toggle/dropped_contents/no_gravity_xp"\
    }\
  }\
]
...
tellraw @s [\
  ...
  {\
    ...
    "clickEvent": {\
      ...
      "value": "/function hygrave:internal/config/change/dropped_contents/item_despawn_time {value: ?}"\ 
    }\
  }\
]
...
tellraw @s [\
  ...
  {\
    ...
    "clickEvent": {\
      "action": "suggest_command",\
      "value": "/function hygrave:internal/config/change/dropped_contents/xp_despawn_time {value: ?}"\ 
    }\
  }\
]
