...
tellraw @s [\
  ...
  {\
    ...
    "clickEvent": {\
      ...
      "value": "/function hygrave:internal/config/change/costs/grave_ropening_costs/owners/items/change_list {value:[{…}]}"\
    }\
  }\
]
...
tellraw @s [\
  ...
  {\
    ...
    "clickEvent": {\
      "action": "suggest_command",\
      "value": "/function hygrave:internal/config/change/costs/grave_ropening_costs/owners/xp {value: ?}"\
    }\
  }\
]
  ...
  {\
    ...
    "with": [\
      {\
        ...
        "clickEvent": {\
          "action": "run_command",\
          "value": "/function hygrave:internal/config/toggle/costs/grave_ropening_costs/owners/gamemodes {gamemode:'survival'}"\
        }\
      },\
      {\
        "translate": " %s ",\
        ...
        "clickEvent": {\
          "action": "run_command",\
          "value": "/function hygrave:internal/config/toggle/costs/grave_ropening_costs/owners/gamemodes {gamemode:'adventure'}"\
        }\
      },\
      {\
        "translate": " %s",\
        ...
        "clickEvent": {\
          "action": "run_command",\
          "value": "/function hygrave:internal/config/toggle/costs/grave_ropening_costs/owners/gamemodes {gamemode:'creative'}"\
        }\
      }\
    ]\
  }\
...
tellraw @s [\
  ...
  {\
    ...
    "clickEvent": {\
      "action": "suggest_command",\
      "value": "/function hygrave:internal/config/change/costs/grave_ropening_costs/non_owners/items/change_list {value:[{…}]}"\
    }\
  }\
]
...
tellraw @s [\
  ...
  {\
    ...
    "clickEvent": {\
      "action": "suggest_command",\
      "value": "/function hygrave:internal/config/change/costs/grave_ropening_costs/non_owners/xp {value: ?}"\
    }\
  }\
]
  ...
  {\
    ...
    "with": [\
      {\
        ...
        "clickEvent": {\
          "action": "run_command",\
          "value": "/function hygrave:internal/config/toggle/costs/grave_ropening_costs/non_owners/gamemodes {gamemode:'survival'}"\
        }\
      },\
      {\
        "translate": " %s ",\
        ...
        "clickEvent": {\
          "action": "run_command",\
          "value": "/function hygrave:internal/config/toggle/costs/grave_ropening_costs/non_owners/gamemodes {gamemode:'adventure'}"\
        }\
      },\
      {\
        "translate": " %s",\
        ...
        "clickEvent": {\
          "action": "run_command",\
          "value": "/function hygrave:internal/config/toggle/costs/grave_ropening_costs/non_owners/gamemodes {gamemode:'creative'}"\
        }\
      }\
    ]\
  }\
  ...
  {\
    ...
    "with": [\
      ...
      {\
        ...
        "clickEvent": {\
          "action": "run_command",\
          "value": "/function hygrave:internal/config/open_page/costs/grave_ropening_costs"\
        }\
      }\
    ]\
  }\
