...
function hygrave:internal/config/change/costs/grave_remote_looting_costs/owners/item_ids/remove_item_index_macro with storage hygrave:common temp.args
