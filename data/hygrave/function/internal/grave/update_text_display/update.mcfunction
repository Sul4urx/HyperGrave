...
execute unless data storage hygrave:common configs.value.graves.text_display.text.line_1.text_1{type: nothing} run data modify storage hygrave:common temp.args.texts[1] append from storage hygrave:common configs.value.graves.text_display.text.line_1.text_1.text
execute unless data storage hygrave:common configs.value.graves.text_display.text.line_1.text_2{type: nothing} run data modify storage hygrave:common temp.args.texts[1] append from storage hygrave:common configs.value.graves.text_display.text.line_1.text_2.text
execute unless data storage hygrave:common configs.value.graves.text_display.text.line_1.text_3{type: nothing} run data modify storage hygrave:common temp.args.texts[1] append from storage hygrave:common configs.value.graves.text_display.text.line_1.text_3.text
...
execute unless data storage hygrave:common configs.value.graves.text_display.text.line_3.text_1{type: nothing} run data modify storage hygrave:common temp.args.texts[3] append from storage hygrave:common configs.value.graves.text_display.text.line_3.text_1.text
execute unless data storage hygrave:common configs.value.graves.text_display.text.line_3.text_2{type: nothing} run data modify storage hygrave:common temp.args.texts[3] append from storage hygrave:common configs.value.graves.text_display.text.line_3.text_2.text
execute unless data storage hygrave:common configs.value.graves.text_display.text.line_3.text_3{type: nothing} run data modify storage hygrave:common temp.args.texts[3] append from storage hygrave:common configs.value.graves.text_display.text.line_3.text_3.text
