...
execute unless data storage hygrave:common configs.value.grave_appearance.text_display_properties.text.line_1.text_1{type: nothing} run data modify storage hygrave:common temp.texts[1] append from storage hygrave:common configs.value.grave_appearance.text_display_properties.text.line_1.text_1.text
execute unless data storage hygrave:common configs.value.grave_appearance.text_display_properties.text.line_1.text_2{type: nothing} run data modify storage hygrave:common temp.texts[1] append from storage hygrave:common configs.value.grave_appearance.text_display_properties.text.line_1.text_2.text
execute unless data storage hygrave:common configs.value.grave_appearance.text_display_properties.text.line_1.text_3{type: nothing} run data modify storage hygrave:common temp.texts[1] append from storage hygrave:common configs.value.grave_appearance.text_display_properties.text.line_1.text_3.text

execute unless data storage hygrave:common configs.value.grave_appearance.text_display_properties.text.line_2.text_1{type: nothing} run data modify storage hygrave:common temp.texts[2] append from storage hygrave:common configs.value.grave_appearance.text_display_properties.text.line_2.text_1.text
execute unless data storage hygrave:common configs.value.grave_appearance.text_display_properties.text.line_2.text_2{type: nothing} run data modify storage hygrave:common temp.texts[2] append from storage hygrave:common configs.value.grave_appearance.text_display_properties.text.line_2.text_2.text
execute unless data storage hygrave:common configs.value.grave_appearance.text_display_properties.text.line_2.text_3{type: nothing} run data modify storage hygrave:common temp.texts[2] append from storage hygrave:common configs.value.grave_appearance.text_display_properties.text.line_2.text_3.text

execute unless data storage hygrave:common configs.value.grave_appearance.text_display_properties.text.line_3.text_1{type: nothing} run data modify storage hygrave:common temp.texts[3] append from storage hygrave:common configs.value.grave_appearance.text_display_properties.text.line_3.text_1.text
execute unless data storage hygrave:common configs.value.grave_appearance.text_display_properties.text.line_3.text_2{type: nothing} run data modify storage hygrave:common temp.texts[3] append from storage hygrave:common configs.value.grave_appearance.text_display_properties.text.line_3.text_2.text
execute unless data storage hygrave:common configs.value.grave_appearance.text_display_properties.text.line_3.text_3{type: nothing} run data modify storage hygrave:common temp.texts[3] append from storage hygrave:common configs.value.grave_appearance.text_display_properties.text.line_3.text_3.text
