...
#@>   function hygrave:internal/grave/remove_grave_entity/drop_items
...
## Set item
data modify entity @n[tag=hygrave.temp.grave.item_to_give_back] Item set from storage hygrave:common graves[-1].drop_queued_contents.items[0]
...
data remove storage hygrave:common graves[-1].drop_queued_contents.items[0]
...
execute if data storage hygrave:common graves[-1].drop_queued_contents.items[0] run function hygrave:internal/grave/remove_grave_entity/drop_items
