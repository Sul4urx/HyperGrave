...
## Save GID + 1 in `temp.mcargs.'grave/show_info/show_non-admin/view_next/loop'.gid` and add 1 to `.gid` temp score
...
execute store result storage hygrave:common temp.mcargs.'grave/show_info/show_non-admin/view_next/loop'.gid int 1 run scoreboard players get .gid hygrave.temp_var
...
return run function hygrave:internal/grave/show_info/show_non-admin/view_next/loop with storage hygrave:common temp.mcargs.'grave/show_info/show_non-admin/view_next/loop'
