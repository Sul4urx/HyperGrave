...
return run function hygrave:internal/grave/show_info/show_admin/view_previous/loop with storage hygrave:common temp.mcargs.'grave/show_info/show_admin/view_previous/loop'
