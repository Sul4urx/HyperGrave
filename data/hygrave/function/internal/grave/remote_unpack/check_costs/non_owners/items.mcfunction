#<< grave/remote_unpack/check_costs/non_owners
...
$execute if data storage hygrave:common configs.value.costs.grave_remote_looting_costs.non_owners.item_ids[0] if predicate {\
