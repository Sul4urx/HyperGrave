...
execute if data storage hygrave:common configs.value.costs.grave_looting_costs.owners.item_ids[0] run function hygrave:internal/grave/pop/check_costs/owners/items with storage hygrave:common configs.value.costs.grave_looting_costs.owners
execute if score .check_costs.items hygrave.temp_var matches 1 if data storage hygrave:common configs.value.costs.grave_looting_costs.owners.item_ids[0] run function hygrave:internal/grave/pop/check_costs/owners/items/remove with storage hygrave:common configs.value.costs.grave_looting_costs.owners
