...
execute store result storage hygrave:common temp.mcargs.'helper/xp_add_level'.value int 1 run data get storage hygrave:common configs.value.requirements.grave_looting_requirements.owners.xp.levels -1
