...
execute if score .loop_count hygrave.temp_var matches 1 run function hygrave:internal/grave/show_list/show/1 with storage hygrave:common temp.args
execute if score .loop_count hygrave.temp_var matches 2 run function hygrave:internal/grave/show_list/show/2 with storage hygrave:common temp.args
execute if score .loop_count hygrave.temp_var matches 3 run function hygrave:internal/grave/show_list/show/3 with storage hygrave:common temp.args
execute if score .loop_count hygrave.temp_var matches 4.. run function hygrave:internal/grave/show_list/show/4 with storage hygrave:common temp.args
