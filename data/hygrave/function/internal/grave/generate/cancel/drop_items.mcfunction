...
## Set item
data modify entity @n[tag=hygrave.temp.grave.item_to_drop] Item set from storage hygrave:common temp.grave_contents.all_items[0]
...
data remove storage hygrave:common temp.grave_contents.all_items[0]
...
execute if data storage hygrave:common temp.grave_contents.all_items[0] run function hygrave:internal/grave/generate/cancel/drop_items
