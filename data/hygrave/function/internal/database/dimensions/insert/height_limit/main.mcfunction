...
function hygrave:internal/database/dimensions/insert/height_limit/test/min with storage hygrave:common temp.args
...
function hygrave:internal/database/dimensions/insert/height_limit/test/max with storage hygrave:common temp.args

## Store values
function hygrave:internal/database/dimensions/insert/height_limit/test/store with entity @s